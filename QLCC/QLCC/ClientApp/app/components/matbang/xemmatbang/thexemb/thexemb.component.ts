...
@Component({
    selector: 'thexemb',
    templateUrl: './thexemb.component.html',
    styleUrls: ['./thexemb.component.css'],
    animations: [fadeInOut]
})
export class TheXeMBComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.columns = [
            ...
            { prop: 'tenLoaiYeuCau', name: gT('Số thẻ xe') },
            { prop: 'kyHieu', name: gT('Chủ thẻ') },
            { prop: 'kyHieu', name: gT('Ngày đăng ký') },
            { prop: 'tenLoaiYeuCau', name: gT('Loại xe') },
            { prop: 'kyHieu', name: gT('Biển số') },
            { prop: 'dienGiai', name: gT('Phí làm thẻ') },
