        ...
        public async Task<IActionResult> Exchange(OpenIdConnectRequest request)
        {
            if (request.IsPasswordGrantType())
            {
                ...
                if (user == null)
                {
                    return BadRequest(new OpenIdConnectResponse
                    {
                        ...
                        ErrorDescription = "Vui lòng kiểm tra lại email và mật khẩu của bạn"
                    });
                }
                ...
                if (!user.IsEnabled)
                {
                    ...
                    {
                        Error = OpenIdConnectConstants.Errors.InvalidGrant,
                        ErrorDescription = "Tài khoản người dùng đã bị vô hiệu hóa"
                    });
                }
                ...
                if (result.IsLockedOut)
                {
                    ...
                    {
                        Error = OpenIdConnectConstants.Errors.InvalidGrant,
                        ErrorDescription = "Tài khoản người dùng đã bị tạm ngưng"
                    });
                }
                ...
                if (result.RequiresTwoFactor)
                {
                    ...
                    {
                        Error = OpenIdConnectConstants.Errors.InvalidGrant,
                        ErrorDescription = "Thủ tục đăng nhập không hợp lệ"
                    });
                }
                ...
                if (result.IsNotAllowed)
                {
                    ...
                    {
                        Error = OpenIdConnectConstants.Errors.InvalidGrant,
                        ErrorDescription = "Người dùng không được phép đăng nhập"
                    });
                }
            ...
            else if (request.IsRefreshTokenGrantType())
            {
                ...
                if (user == null)
                {
                    ...
                    {
                        Error = OpenIdConnectConstants.Errors.InvalidGrant,
                        ErrorDescription = "Làm mới token không hợp lệ"
                    });
                }
            ...
            return BadRequest(new OpenIdConnectResponse
            {
                ...
                ErrorDescription = "Loại hỗ trợ đã chỉ định không được hỗ trợ"
            });
        }
