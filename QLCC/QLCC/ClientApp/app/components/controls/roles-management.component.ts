...
export class RolesManagementComponent implements OnInit, AfterViewInit {
    ...
    ngOnInit() {
        ...
        this.columns = [
            ...
            { prop: 'usersCount', name: gT('roles.management.Users'), width: 100 },
    ...
    loadData() {
        ...
        this.accountService.getRolesAndPermissions()
            ...
            error => {
                ...
                this.alertService.showStickyMessage("Tải lỗi", `Không thể truy xuất vai trò từ máy chủ.\r\nLỗi: "${Utilities.getHttpResponseMessage(error)}"`,
    ...
    deleteRole(row: Role) {
        this.alertService.showDialog('Bạn có chắc chắn muốn xóa vai trò \"' + row.name + '\"?', DialogType.confirm, () => this.deleteRoleHelper(row));
    }
    ...
    deleteRoleHelper(row: Role) {
        ...
        this.accountService.deleteRole(row)
            ...
            error => {
                ...
                this.alertService.showStickyMessage("Lỗi xóa", `Đã xảy ra lỗi khi xóa vai trò.\r\nLỗi: "${Utilities.getHttpResponseMessage(error)}"`,
                    MessageSeverity.error, error);
            });
    }
