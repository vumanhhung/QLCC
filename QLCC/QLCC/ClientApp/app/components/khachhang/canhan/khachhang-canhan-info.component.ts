...
@Component({
    selector: "khachhang-canhan-info",
    templateUrl: "./khachhang-canhan-info.component.html",
    styleUrls: ["./khachhang-canhan-info.component.css"]
})

export class KhachHangCaNhanInfoComponent implements OnInit {
    public isFullScreenModal: boolean = false;
    isViewDetails = false;
    private isEdit = false;
    public tenkhachhangcanhan: string = "";
    ...
    public valueNgayCap: Date = new Date();
    ...
    private save() {
        ...
        if (this.chkquocTich == false || this.chknganHang == false || this.isValidateEmail == false || !this.chkNhomKhachHang) { return false; }
        else {
            this.isSaving = true;
            this.alertService.startLoadingMessage("Đang thực hiện lưu thay đổi...");
            this.KhachHangEdit.ngaySinh = this.valueNgaySinh;
            this.KhachHangEdit.ngayCap = this.valueNgayCap;
            this.KhachHangEdit.khDoanhNghiep = false;
            if (this.isNew) {
