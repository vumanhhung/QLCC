...
@Component({
    selector: 'lichsusudung',
    templateUrl: './lichsusudung.component.html',
    styleUrls: ['./lichsusudung.component.css'],
    animations: [fadeInOut]
})
export class LichSuSuDungComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.columns = [
            ...
            { prop: 'tenLoaiYeuCau', name: gT('Mã KH') },
            { prop: 'kyHieu', name: gT('Họ tên') },
            { prop: 'kyHieu', name: gT('Trạng thái mặt bằng') },
            { prop: 'tenLoaiYeuCau', name: gT('Ngày bắt đầu') },
            { prop: 'kyHieu', name: gT('Ngày kết thúc') },
