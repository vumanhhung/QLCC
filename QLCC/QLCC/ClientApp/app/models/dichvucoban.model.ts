export class DichVuCoBan {
    ...
    constructor(dichVuCoBanId?: number, soChungTu?: string, ngayChungTu?: Date, matBangId?: number, khachHangId?: number, loaiDichVuId?: number, donViTinhId?: number, donGia?: number, soLuong?: number, thanhTien?: number, ngayThanhToan?: Date, kyThanhToan?: number, tienThanhToan?: number, tienTTQuyDoi?: number, loaiTienId?: number, tyGia?: number, tuNgay?: Date, denNgay?: Date, dienGiai?: string, lapLai?: boolean, trangThai?: number, ngayNhap?: Date, nguoiNhap?: string, ngaySua?: Date, nguoiSua?: string)
    {
