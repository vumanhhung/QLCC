export class HopDong {
		...
		public thoiHan: string;
		public kyThanhToan: string;
		public hanThanhToan: string;
    ...
    constructor(hopDongId?: number, tenhopDong?: string, soHopDong?: string, loaiHopDong?: number, mauHopDong?: string, khachHangId?: number, ngayKy?: Date, ngayHieuLuc?: Date, thoiHan?: string, kyThanhToan?: string, hanThanhToan?: string, ngayBanGiao?: Date, tyleDCGT?: number, soNamDCGT?: number, mucDCGT?: number, loaiTienId?: number, tyGia?: number, giaThue?: number, tienCoc?: number, nguoiNhap?: string, ngayNhap?: Date, nguoiSua?: string, ngaySua?: Date)
    {
