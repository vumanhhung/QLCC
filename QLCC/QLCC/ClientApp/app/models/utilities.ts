...
export class Utilities {
    ...
    public static readonly noNetworkMessageCaption = "Không có mạng";
    public static readonly noNetworkMessageDetail = "Không thể truy cập máy chủ";
    public static readonly accessDeniedMessageCaption = "Truy cập bị từ chối!";
    ...
    public static RandomText(nmberIndex: number): string {
        var text: string = "";
        var list: string = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
        for (var i = 0; i < nmberIndex; i++) {
