...
@Component({
    selector: 'lichsuthuphi',
    templateUrl: './lichsuthuphi.component.html',
    styleUrls: ['./lichsuthuphi.component.css'],
    animations: [fadeInOut]
})
export class LichSuThuPhiComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.columns = [
            ...
            { prop: 'tenLoaiYeuCau', name: gT('Số phiếu') },
            { prop: 'kyHieu', name: gT('Ngày nộp') },
            { prop: 'kyHieu', name: gT('Địa chỉ') },
            { prop: 'tenLoaiYeuCau', name: gT('Số tiền') },
            { prop: 'kyHieu', name: gT('Loại dịch vụ') },
            { prop: 'dienGiai', name: gT('Ngày thanh toán') },
